...
import productJoi from "../validation/productValidation";
        ...
        try {
            ...
            if (prodcut) {
                return handleResponse({
                    res,
                    msg: "product Registered already!! please create new"
                });
            } else {
        ...
        try {
            ...
            if (!productID) {
                ...
                if (!singleProduct) {
                    return handleResponse({
                        res,
                        msg: "No Data available for this ID"
                    });
                } else {
                    return handleResponse({
                        res,
    ...
    deleteProduct: async(req, res) => {
        try {
            ...
            if (!toBeDeletedData) {
                return handleResponse({
                    res,
                    msg: "There is no rpoduct to be deleted"
                });
            } else {
